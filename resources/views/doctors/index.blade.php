<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="flex-1"> <p class="p-2">{{$doctor->ime}}  {{$doctor->prezime}} - {{$doctor->specijalizacija}} - {{$doctor->datum}}</p></div>
                <div class="flex-2">
    ...
    <div class="flex-2">
            ...
            <div class ="p-2">
                <h1 class="font-xl">Ovdje će biti izlistani kardiolozi:</h1>
        
            @foreach($doctors2 as $doctor2)
            <div class="flex space-x-4">
            <div class="flex-1"> <p class="p-2">{{$doctor2->ime}}  {{$doctor2->prezime}} </p></div>
