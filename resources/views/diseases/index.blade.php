...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class ="p-2">
                    <h1 class="font-xl">Ovdje će biti izlistane bolesti, njihovi simptomi i lijek za tu bolest:</h1>
    ...
    <div class="flex-2">
            ...
            <div class ="p-2">
                <h1 class="font-xl">Ovdje će biti izlistane bolesti za koje je lijek paracetamol:</h1>
